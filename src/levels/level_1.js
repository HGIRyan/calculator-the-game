...
export default class Level1 extends Component {
    ...
    constructor() {
        ...
        this.state = {
            ...
            currentNum: 1,
            continue: false,
            emojiUrl: 'http://www.stickpng.com/assets/images/587389d1f3a71010b5e8ef4a.png',
            goal: 25, //DESIRED GOAL -1
        }
    }
    ...
    addNum() {
        ...
        let newTotal = numTotal + buttonNum // <--- button Logic
    ...
    squareNum() {
        let numTotal = this.state.currentNum
        let newTotal = numTotal * numTotal // <--- button Logic
        let moves = this.state.moves
        let newMoves = moves - 1
        if (newMoves > -1) {
            this.setState({
    ...
    squareRootNum() {
        let numTotal = this.state.currentNum
        let newTotal = Math.sqrt(numTotal)// <--- button Logic
        let moves = this.state.moves
        let newMoves = moves - 1
        if (newMoves > -1) {
            this.setState({
            ...
            <div className="App">
                ...
                <div className='phone'>
                    ...
                    <div className='screen'>
                        ...
                        <div className='screenDisplay'>
                            ...
                            <div className='levelInfo'>
                                ...
                                <h4>Moves: {this.state.moves-1}</h4>
                    ...
                    */}
                    <div className='input'>
                        <div className='row_1'>
                            <button className='numPad_1' onClick={(e) => { this.addNum(e.target.value) }}> +1</button>

                            <button className='numPad_2' onClick={(e) => { this.multiplyNum(e.target.value) }}>x5</button>
                        ...
                        <div className='row_2'>
                            <button className='numPad_4' onClick={(e) => { this.divideNum(e.target.value) }}>÷6</button>

                            <button className='numPad_5' onClick={(e) => { this.subtractNum(e.target.value) }}>-3</button>

                            <button className='numPad_6' onClick={(e) => { this.squareNum(e.target.value) }}>X²</button>

                        </div>
                        <div className='row_3'>
                            <button className='numPad_7' onClick={(e) => { this.squareRootNum(e.target.value) }}>√x</button>
